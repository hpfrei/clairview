...
function writeToolFile(tool) {
  ...
  const code = `// Auto-generated by vistaclair — handler body is preserved on regeneration.
import { z } from "zod";
...
function generateServerJs() {
  ...
  const code = `// Auto-generated by vistaclair dashboard — do not edit.
// Manage tools via the dashboard's MCP Tools panel.
import { McpServer } from "@modelcontextprotocol/sdk/server/mcp.js";
${imports.join('\n')}

const server = new McpServer({
  name: ${JSON.stringify(meta.name || 'vistaclair-tools')},
  version: "1.0.0",
});
